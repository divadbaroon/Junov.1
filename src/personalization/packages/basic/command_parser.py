import yaml
from src.personalization.packages.basic.commands.low_intent.ask_gpt.ask_gpt import AskGPT
...
class CommandParser:
	...
	def load_commands(self):
		...
		commands_file_path = 'src/personalization/packages/basic/supported_commands.yaml'
