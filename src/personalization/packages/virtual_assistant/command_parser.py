...
from src.personalization.packages.virtual_assistant.commands.high_intent.get_weather.get_weather import GetWeather
from src.personalization.packages.virtual_assistant.commands.high_intent.web_searcher.web_searcher import WebSearcher
from src.personalization.packages.virtual_assistant.commands.high_intent.set_timer.set_timer import StartTimer
from src.personalization.packages.virtual_assistant.commands.high_intent.generate_password.password_generator import PasswordGenerator
from src.personalization.packages.virtual_assistant.commands.high_intent.get_news.get_news import GetNews
#from src.personalization.packages.virtual_assistant.commands.high_intent.play_music.play_music import PlaySong
from src.personalization.packages.virtual_assistant.commands.high_intent.schedule_event.scheduler import Scheduler
from src.utilities.conversation_history.conversation_history_manager import ConversationHistoryManager
from src.personalization.packages.basic.commands.high_intent.bot_behavior.bot_behavior import BotBehavior
...
class CommandParser:
	...
	def load_commands(self):
		...
		commands_file_path = 'src/personalization/packages/virtual_assistant/supported_commands.yaml'
